...
{
    public class AbpSampleDbMigrationService : ITransientDependency
    {
        public ILogger<AbpSampleDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IAbpSampleDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public AbpSampleDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IAbpSampleDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<AbpSampleDbMigrationService>.Instance;
        }
